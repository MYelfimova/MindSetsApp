...
class CardPopupViewController: UIViewController {
    ...
    //fileprivate let containerView = UIView(frame: CGRect(x: 0.0, y: 0.0, width: 335.0, height: 270.0))
    ...
    fileprivate var popupProtocolResponder: CardPopupContent? {
        
        if let contentViewController = contentViewController {
            if let protocolResponder = contentViewController as? CardPopupContent {
                return protocolResponder
            }
        }
        else if let protocolResponder = contentView as? CardPopupContent {
            return protocolResponder
        }
    ...
    public override func updateViewConstraints() {
        ...
        //contentView.frame.size.width = 375
    }
    ...
    private func applyContainerViewConstraints() {
        ...
        // MARK: Masha
//        let widthConstraint = NSLayoutConstraint(item: containerView,
//                                     attribute: .width,
...
//                                                       constant: 0)
//
//        aspectRatioConstraint.priority = UILayoutPriority.defaultLow
//
//
//        let limitWidth = NSLayoutConstraint(item: containerView,
//                                             attribute: .height,
//                                             relatedBy: .lessThanOrEqual,
//                                             toItem: view,
//                                             attribute: .height,
//                                             multiplier: 1.0,
//                                             constant: 375)
//        limitWidth.priority = UILayoutPriority.defaultHigh
//
        //MARK: End Masha
